...
static const uint32_t GZIID_cIPropQueryCustomToolTipHookTarget = 0xA23744D1;

class cIPropQueryCustomToolTipHookTarget : public cIGZUnknown
{
public:
	/**
	 * @brief A callback that allows for customized prop query hover tool tips.
